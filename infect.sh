...
╠══════════╩════╦═════════════╦══════════════╣
║\033[1;36mGITHUB:BINOD-XD\033[1;32m║\033[1;36mVERSION:1.0.0\033[1;32m║\033[1;36m RXS INFECT \033[1;32m ║\033[1;32m
╚═══════════════╩═════════════╩══════════════╝
\033[1;91m\033[1;46m\033[1;97m             RXS INFECT TOOLS            \033[;0m\033[1;91m\033[1;92m'
echo " " 
...
menu(){
echo -e "$grn             ======$ylo [Select Options]$grn ======$rset"
echo " "
...
And We Are not responsible for any kind of loss 
...
echo -e '\e[91m
         ...
         ────▌──▐────
'
echo -e "\e[93m                  CALL ME \e[92mRXS" | pv -qL 10
echo -e "\e[93m             IAM FROM \e[92mBINOD-XD" | pv -qL 10
...
echo -e "\e[93m              JOIN GROUPS ON \e[92mFACEBOOK" | pv -qL 10
echo -e "\e[93m        MY FACEBOOK:\e[92m www.facebook.com/reyadbross\e[0m" | pv -qL 10
...
while git clone https://github.com/reyadz/infect 2> /dev/null; do 
    printf  "\e[92m▓▓▓▓▓▓▓▓▓▓▓▓▓\e[0m"
    sleep 1
done
printf "\e[96m]\e[0m"
...
clear
echo -e "\e[96m                ╔═══════════════════════════════════╗\e[0m"
echo -e "\e[96m                ║  \e[93mDO YOU WANT TO SEE MORE\e[96m TOOLS   ║\e[0m"
echo -e "\e[96m                ║      VISIT GITHUB NOW.....!    ║\e[0m"
echo -e "\e[96m                ║                                   ║\e[0m"
echo -e "\e[96m                ║        Select \e[92my\e[96m to visit\e[96m          ║\e[0m"
...
if [ "$p" = "y" ];
then
am start -a android.intent.action.VIEW -d https://github.com/BINOD-XD 2>/dev/null
clear
baner1
menu
elif [ "$p" = "t" ];
